...
class HSDGFLHead(AnchorHead):
    ...
    def __init__(
        ...
        super(HSDGFLHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, labels, label_weights,
        ...
        if len(pos_inds) > 0:
            ...
            loss_dfl, loss_hsd = self.loss_dfl(
                pred_corners,
                target_corners,
                soft_corners,
        ...
        return loss_cls, loss_bbox, loss_dfl, loss_hsd, weight_targets.sum()
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_dfl, losses_hsd,\
        ...
        # losses_hsd = list(map(lambda x: x / avg_factor, losses_hsd))
        return dict(
            loss_cls=losses_cls,
